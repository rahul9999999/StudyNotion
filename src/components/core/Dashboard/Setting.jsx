...
import { deleteAccount, updateAdditionalDetails, updatePassword, updatePfp } from '../../../services/operations/profileApi'
        ...
        <div className='flex items-center justify-between rounded-md border-[1px] border-richblack-700 bg-richblack-800 md:p-8 md:px-12 px-3 py-3 text-richblack-5'>
          <div className='flex items-center gap-x-4'>
            ...
            <input id='upload' type="file" onChange={handleFileChange} className="hidden" accept="image/png, image/gif, image/jpeg"/></label>
             <button type='submit' className={uploadBtn?`flex items-center bg-yellow-400 cursor-pointer gap-x-2 rounded-md py-2 px-5 font-semibold text-richblack-600 undefined`:`flex items-center bg-yellow-50 cursor-pointer gap-x-2 rounded-md py-2 px-5 font-semibold text-richblack-900 undefined`} disabled={uploadBtn}>Upload</button>
            </div>
            </form>
            </div>
          </div>
