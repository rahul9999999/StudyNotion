...
const CourseDetails = () => {
    ...
    useEffect (() => {
    if(courseDetail){
        const Enrolled = courseDetail?.studentEnrolled?.find((student) => student === user?._id);
            ...
            <div className='mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]'>
                <div className='relative block max-h-[30rem] lg:hidden'>
                    <div className='absolute bottom-0 left-0 h-full w-full shadow-[#161D29_0px_-64px_36px_-28px_inset]'></div>
                        <img src={courseDetail?.thumbnail?.url} alt="courseImg" />
                </div>
                    <div className='z-30 my-5 flex flex-col justify-center gap-4 py-5 text-lg text-richblack-5'>  
                        ...
                        {/* student enrolled */}
                        <span className='text-richblack-200'>{courseDetail?.studentEnrolled?.length} students enrolled</span>
                    </div>
                    <div>
                ...
                <div className='right-[1rem] top-[60px] mx-auto hidden min-h-[600px] w-1/3 max-w-[410px] translate-y-24 md:translate-y-0 lg:absolute  lg:block'>
                    <div className='flex flex-col gap-4 rounded-md bg-richblack-700 p-4 text-richblack-5'>
                        <img src={courseDetail?.thumbnail?.url} alt="course img" className='max-h-[300px] min-h-[180px] w-[400px] overflow-hidden rounded-2xl object-cover md:max-w-full' />
                        <div className='px-4'>
                            ...
                            <div className=''>
                                ...
                                <div className='flex flex-col gap-1 text-sm text-caribbeangreen-100'>
                                    {
                                        courseDetail?.instruction.map((item,index) => (
