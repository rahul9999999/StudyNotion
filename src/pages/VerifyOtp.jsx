...
const VerifyOtp = () => {
    ...
    function handleOnSubmit(e) {
        e.preventDefault()
        const { firstName, lastName, password, email, confirmPassword, accountType } = signupData
        dispatch(signUp(firstName, lastName, password, email, confirmPassword, otp, accountType ,navigate))
    }
    return (
